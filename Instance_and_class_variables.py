...
# we can access class variables by self and by class-name also.
# By using class name we would change that class variable for all instances of that class.
# But by using self we can change the class variable for each and every instance variable separately.
...
class Employee:
    ...
    def __init__(self, first, last, pay):
        ...
        # accessing class variable by class-name
...
emp1 = Employee('pratik', 'barjatiya', 50000)
emp2 = Employee('foo', 'bar', 20000)
